...
import (
	...
	api "github.com/emmrys-jay/proglog/api/v1"
	"github.com/emmrys-jay/proglog/internal/auth"
	"github.com/emmrys-jay/proglog/internal/config"
	"github.com/emmrys-jay/proglog/internal/log"
...
func setupTest(t *testing.T, fn func(*Config)) (rootClient api.LogClient, nobodyClient api.LogClient, cfg *Config, teardown func()) {
	...
	return rootClient, nobodyClient, cfg, func() {
		...
		if telemetryExporter != nil {
			time.Sleep(1500 * time.Millisecond) // We sleep for 1.5 seconds to give the telemetry exporter enough time to flush its data to disk.
